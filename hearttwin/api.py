...
class VirelionServices:
    """Convenience facade: one object exposes registered Virelion capabilities."""
    ...
    def simulate_cardiac_twin(self, entity_id:str, **p): return self.call("simulation.cardiac_twin",entity_id,**p)
